...
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-I/usr/local/include/mysql']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/usr/home/chris/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_MYSQLCLIENT_R = ['mysqlclient_r']
LIB_ST = '-l%s'
LINKFLAGS = ['-L/usr/local/lib/mysql', '-lmysqlclient_r', '-lz', '-pthread', '-lcrypt', '-lm']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
MYSQL_CONFIG = '/usr/local/bin/mysql_config'
NODE_PATH = '/usr/home/chris/.node_libraries'
PREFIX = '/usr/local'
